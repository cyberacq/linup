...
show_help() {
    cat << EOF
Linux Updater with Multi-Distro Support - Installer v2.2
...
show_version() {
    echo "Linux Updater with Multi-Distro Support - Installer v2.2"
    exit 0
}
...
main() {
    echo ""
    print_header "Linux Updater with Multi-Distro Support - Installer v2.2"
    echo ""
